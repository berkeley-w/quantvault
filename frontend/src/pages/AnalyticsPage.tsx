            ...
            <DataTable
              columns={[
                ...
                { key: "sector", header: "Sector" },
                {
                  ...
                  header: "Mkt Value",
                  align: "right",
                  render: (r: any) => formatCurrency(r.market_value),
                },
                {
                  key: "pnl",
                  header: "P&L",
                ...
                },
                {
                  ...
                  align: "right",
                  render: (r: any) =>
                    r.pnl_pct != null ? formatPercent(r.pnl_pct) : "N/A",
                },
                {
                  key: "portfolio_weight_pct",
                  header: "Weight %",
                  align: "right",
                  render: (r: any) => formatPercent(r.portfolio_weight_pct),
                },
                {
                  key: "beta",
                  header: "Beta",
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <PieChart>
                    <Pie
                      ...
                      outerRadius={80}
                      label={({ name, value }) =>
                        `${name}: ${formatPercent(value as number)}`
                      }
                    >
                      {positions.map((_, idx) => (
                        <Cell
